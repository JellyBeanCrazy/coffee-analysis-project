...
from sensitivity_analysis import run_parameter_sweep, plot_results
import pandas as pd
...
## Testing the sweeping parameters and how that affects the country outcomes
series = run_parameter_sweep(df, iterations=500)
plot_results(series)
